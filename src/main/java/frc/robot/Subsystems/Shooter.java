...
public class Shooter extends SubsystemBase {
    public static TalonSRX shooterMaster = new TalonSRX(Constants.SHOOTER_WHEEL_MOTOR_ONE);
    public static TalonSRX shooterSlave = new TalonSRX(Constants.SHOOTER_WHEEL_MOTOR_TWO);

    public static TalonSRX turret = new TalonSRX(Constants.TURRET_MOTOR);

    public static TalonSRX ballPump = new TalonSRX(Constants.BALL_PUMP_MOTOR);
    
    public static TalonSRX indexer = new TalonSRX(Constants.INDEXER_MOTOR);
    ...
    public static void BallPump(double rpm){
        ballPump.set(ControlMode.PercentOutput, rpm);
    }
    public static void stopBallPump(){
        ballPump.set(ControlMode.PercentOutput, 0);
    }

    public static void Indexer(double rpm){
        indexer.set(ControlMode.PercentOutput, rpm);
    }
