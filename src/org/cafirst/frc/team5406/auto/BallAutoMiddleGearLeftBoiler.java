...
public class BallAutoMiddleGearLeftBoiler extends AutonomousRoutine{
	...
	/**
	 * Constructor for Middle Gear and Left Boiler Auto
	 ...
	 */
	public BallAutoMiddleGearLeftBoiler(Drive robotDrive, Shooter robotShooter, Intake robotIntake)
	{
	...
	public void periodic()
	{
		if(robotShooter.findRevLimit() && turretStatus == 0)
			turretStatus = robotShooter.turnTurret(-122);
	...
	public AutonomousRoutine newInstance() {
		return new BallAutoMiddleGearLeftBoiler(robotDrive, robotShooter, robotIntake);
	}
}
