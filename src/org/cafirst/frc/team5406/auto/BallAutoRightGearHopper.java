...
public class BallAutoRightGearHopper extends AutonomousRoutine{
	...
	/**
	 * Constructor for Right Gear and Hopper Auto
	 ...
	 */
	public BallAutoRightGearHopper(Drive robotDrive, Shooter robotShooter, Intake robotIntake)
	{
	...
	public AutonomousRoutine newInstance() {
		return new BallAutoRightGearHopper(robotDrive, robotShooter, robotIntake);
	}
}
